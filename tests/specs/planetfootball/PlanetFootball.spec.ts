...
test.describe('PlanetFootball', () => {
  ...
  const isIgnorableConsoleError = (t: string) => {
    ...
    return (
      ...
      lower.includes("requested an insecure frame 'http://") ||
      lower.includes('pmbmonetize.live') ||
      lower.includes('cookies.nextmillmedia.com') ||
      ...
      lower.includes('refused to display') ||
